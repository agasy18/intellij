...
public class BlazeAndroidSyncPluginTest extends BlazeTestCase {
   ...
   * {@link ProjectRootManagerEx} obtains it's own instance. See {@link
  ...
  public void testUpdateProjectSdkWithSyncData() {
    ...
    // Perform.
    BlazeAndroidSyncPlugin plugin = new BlazeAndroidSyncPlugin();
    plugin.updateProjectSdk(project, context, projectViewSet, null, blazeProjectData);
    ...
    Truth.assertThat(rootManager.getProjectSdk().getName()).isEqualTo("android-sdk-26");
    // Defaults to JDK 1.8, but sync result specifies 1.9, which takes higher priority.
    Truth.assertThat(languageLevel).isEquivalentAccordingToCompareTo(LanguageLevel.JDK_1_9);
  }
  ...
  public void testUpdateProjectSdkWithoutSyncData() {
    ...
    Truth.assertThat(rootManager.getProjectSdk().getName()).isEqualTo("android-sdk-28");
    Truth.assertThat(languageLevel)
        .isEquivalentAccordingToCompareTo(LanguageLevel.JDK_1_8); // Defaults to JDK 1.8
  }
  ...
  public void testUpdateProjectSdkWithoutSyncDataDoesNotOverrideSdkIfOneAlreadyExists() {
    ...
    Truth.assertThat(rootManager.getProjectSdk().getName()).isEqualTo("android-sdk-26");
    Truth.assertThat(languageLevel).isNull();
  }
